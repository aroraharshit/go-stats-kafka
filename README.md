...
```
cd existing_repo
git remote add origin https://gitlab.com/aroraharshit/go-kafka-stat.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/aroraharshit/go-kafka-stat/-/settings/integrations)
...
>>>>>>> 1e14d49c56ff9c4a2af7a7dfa1cb632cd4db0cd3
